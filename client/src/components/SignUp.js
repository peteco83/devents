...
const SignUp = () => {
  ...
  const { userData, setUserData, setToken, loggedIn, setLoggedIn } = useContext(
    Context
  );
  ...
  const orgAvatars = [orgAvatar3, orgAvatar4];
      ...
      <form className="signup-form puff-in-center" onSubmit={handleSignUp}>
        ...
        <label className="signup-label">
          ...
          <select
            ...
            onChange={(e) => setTypeOfUser(e.currentTarget.value)}
          >
            <option className="signup-opt" value="developer" selected>
              Developer
            </option>
            <option className="signup-opt" value="organization">
              Organization
            </option>
          </select>
        </label>
        <label className="signup-label">
          {typeOfUser === "developer" ? "Name *" : "Organization's name *"}
          <input
        ...
        <button type="submit" className="button sign-btn">
          CREATE ACCOUNT
        </button>
      </form>
    </div>
